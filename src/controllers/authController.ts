...
import { RegisterUserRequestType, LoginUserRequestType } from '../types/User';

const register = async (req: Request<{}, {}, RegisterUserRequestType>, res: Response, next: NextFunction) => {
  try {
    ...
    if (password !== confirmPassword) return throwError('Passwords do not match', 400);
...
const login = async (req: Request<{}, {}, LoginUserRequestType>, res: Response, next: NextFunction) => {
  try {
