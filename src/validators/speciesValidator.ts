...
const patchSpeciesSchema = baseSpeciesSchema.fork(
  Object.keys(baseSpeciesSchema.describe().keys),
  (field) => field.optional()
);

export const validateSpeciesPost = (species: Partial<SpeciesDocument>) => {
  return baseSpeciesSchema.validate(species, { abortEarly: false });
};

export const validateSpeciesPatch = (species: Partial<SpeciesDocument>) => {
